...
this.state.persons.map(item => {
  ...
  if (item.recognitionMessage.toLowerCase().includes(e.target.value.toLowerCase())&& e.target.value.length>0) {
    temp = {
...
return (
  <div className="PageContent">
    ...
    <div className="head2"><Tags sortedArr={this.state.sortedArr} changeF={()=>this.changeF()}  currentPage={this.state.currentPage} /></div>
    <div className="searching"> <SearchBar searchFunc={(e) => this.filterMessage(e)} /></div>
    <Initial persons={this.state.persons} currentPage={this.state.currentPage} />
    ...
    return (
      <div className="PageContent">
        ...
        <div className="head2"><Tags sortedArr={this.state.sortedArr} changeF={()=>this.changeF()} currentPage={this.state.currentPage} /></div>
        <div className="searching"> <SearchBar searchFunc={(e) => this.filterMessage(e)} /></div>
        <Final data={this.state.data} currentPage={this.state.currentPage} />
        <div class="pagination">
          <a href="#">&laquo;</a>
          {buttons}
          <a href="#">&raquo;</a>
